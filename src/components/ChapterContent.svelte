...
<nav class="fixed bottom-0 left-0 lg:left-[220px] right-0 z-20 border-t border-sage-100 px-6" style="background-color: #f7faf8; min-height: 80px; display: flex; align-items: center;">
