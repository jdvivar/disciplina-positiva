...
<nav class="flex flex-col h-full bg-sage-50 border-r border-sage-100">
  ...
  <div class="px-5 pt-6 pb-4">
    <a href="/" data-astro-reload class="flex items-center gap-2 font-heading text-base font-semibold text-sage-700 leading-tight hover:text-sage-900 transition-colors">
