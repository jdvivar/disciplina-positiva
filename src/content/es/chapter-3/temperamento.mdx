---
title: "Dimensiones del temperamento"
chapter: 3
order: 465
---
...
Otros, se ajustan lentamente. Pueden tardar meses en hacer amigos en un barrio nuevo, o sentirse cómodos en una nueva escuela, o seguir un nuevo calendario.
...
<div data-exercise-id="temperament-child-2" data-exercise-type="multi-section" data-exercise-title="Temperamento de tu hijo/a" data-exercise-list-count="0" data-exercise-questions='["Las formas en que el temperamento de mi hijo/a es una virtud:","Las formas en que el temperamento de mi hijo/a es una desventaja:"]'>
...
No solamente el temperamento de un niño/a afecta el comportamiento de padres y madres. También el temperamento de los padres incide en el comportamiento de tu hijo/a.
...
Es muy importante que los padres y madres reflexionen sobre su propio temperamento y consideren qué tan bien coinciden con el de sus hijos/as. Tener esto en cuenta nos puede ayudar a entender por qué surgen tantos conflictos familiares.

<div data-exercise-id="temperament-self" data-exercise-type="self-assessment" data-exercise-title="Tu temperamento">
...
<div data-exercise-id="temperament-self-reflection" data-exercise-type="multi-section" data-exercise-title="Reflexión sobre tu temperamento" data-exercise-list-count="0" data-exercise-questions='["Piensa de qué manera tu temperamento es una fortaleza.","Ahora piensa en qué forma tu temperamento no es una fortaleza."]'>
...
En esta etapa los niños/as se ven enfrentados a situaciones complicadas por primera vez. Tienen que resolver situaciones como:
...
- Ser leales, aun cuando sea difícil
- Ser gentiles, aun cuando otros no lo sean
...
Los niños/as que se sienten capaces y valorados tienen más probabilidades de tomar buenas decisiones.
...
Podemos construir sobre los fundamentos que hemos creado en los años previos. Y podemos preparar el terreno para que tomen sus propias decisiones en la adolescencia.
